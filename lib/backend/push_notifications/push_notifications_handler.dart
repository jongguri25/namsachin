...
final parametersBuilderMap =
  ...
  'AllCharacters': ParameterData.none(),
  ...
  'chatapge2': (data) async => ParameterData(
        allParams: {
          'character': getParameter<DocumentReference>(data, 'character'),
          'chatReference':
              getParameter<DocumentReference>(data, 'chatReference'),
          'characterProfile': getParameter<String>(data, 'characterProfile'),
          'characterName': getParameter<String>(data, 'characterName'),
          'prompt': getParameter<String>(data, 'prompt'),
          'chat': await getDocumentParameter<ChatsRecord>(
              data, 'chat', ChatsRecord.fromSnapshot),
        },
      ),
  'Profile16CreateEdit': ParameterData.none(),
  'Details09PlayerProfile': ParameterData.none(),
  'photoUpload': (data) async => ParameterData(
        allParams: {
          'character': getParameter<DocumentReference>(data, 'character'),
        },
      ),
